...
class TwoMoons(NNGraph):
    ...
    def __init__(self, moontype='standard', dim=2, sigmag=0.05, N=400, sigmad=0.07, distance=0.5, seed=None, **kwargs):
        ...
        super(TwoMoons, self).__init__(Xin=Xin, sigma=sigmag, k=5, center=False, rescale=False, plotting=plotting, **kwargs)
