...
try:
    commutes = pd.read_excel(os.path.join(assets_dir, '2023.11 Matriz_baj_SS_MH.xlsb'),
                             header=1, sheet_name='bajadas_prom_laboral')
...
print(f'{len(stations_missing)} Stations Not Measured:')
